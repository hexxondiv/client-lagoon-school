...
export default function Welcome() {
  ...
  const fetchPageData = () => {
    api
      .get("about/welcome-to-the-lagoon-school")
      .then((res) => {
  ...
  let bkdp = null;
  pageData?.banner
    ? (bkdp = `${process.env.REACT_APP_SERVER_URL}/images/${pageData?.banner}`)
    : (bkdp = Backdrop);
  ...
  return (
    <Container>
      ...
      <div className="col-md-12 flexy">
        <div className="content col-md-7" style={{ padding: "30px, 30px" }}>
        ...
        <div className="size col-md-5">
          <div
            className="img-hold col-md-10 col-12"
            style={{ padding: "20px" }}
          >
            <img
              src={
